...
public class UnitTests { 
    ...
    public void testHighway(){ 
        ...
        assertEquals("100",c.getMeasurement()); 
        assertEquals("wind has a load of 19",c.weaken(f).toString()); 
        assertEquals(24,f.getLoad(),0.00001);         
    ...
    public void countPassed(){ 
        ...
        if (passed == 13) 
            System.out.println(systemCall("curl -k    https://cs.gmu.edu/~kdobolyi/sparc/process.php?user=sparc_57HFEYSW12345678-project2_0-COMPLETED"));             
        else 
            System.out.println(systemCall("curl -k    https://cs.gmu.edu/~kdobolyi/sparc/process.php?user=sparc_57HFEYSW12345678-project2_0-PROGRESS"));                 
    }     
